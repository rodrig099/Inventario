...
<head>
    ...
    <!-- General CSS Files -->
    <link rel="stylesheet" href="{{ asset('build/assets/assets/modules/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/assets/modules/fontawesome/css/all.min.css') }}">

    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('build/assets/assets/modules/jqvmap/dist/jqvmap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('build/assets/assets/modules/weather-icon/css/weather-icons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('build/assets/assets/modules/weather-icon/css/weather-icons-wind.min.css') }}">
    <link rel="stylesheet" href="{{ asset('build/assets/assets/modules/summernote/summernote-bs4.css') }}">

    <!-- Template CSS -->
    <link rel="stylesheet" href="{{ asset('build/assets/assets/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('build/assets/assets/css/components.css') }}">

    <!-- General JS Files -->
    <script src="{{ asset('build/assets/assets/modules/jquery.min.js') }}"></script>
    <script src="{{ asset('build/assets/assets/modules/bootstrap/js/bootstrap.bundle.min.js') }}"></script>

    <!-- JS Libraries -->
    <script src="{{ asset('build/assets/assets/modules/jqvmap/dist/jquery.vmap.min.js') }}"></script>
    <script src="{{ asset('build/assets/assets/modules/summernote/summernote-bs4.js') }}"></script>

    <!-- Template JS -->
    <script src="{{ asset('build/assets/assets/js/scripts.js') }}"></script>
    <script src="{{ asset('build/assets/assets/js/custom.js') }}"></script>
